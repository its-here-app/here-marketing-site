...
export declare const getMediaPlaylistFromMultivariantPlaylist: (multivariantPlaylist: string) => Promise<string>;
...
export declare const setupHls: (props: Partial<Pick<MuxMediaPropsInternal, "debug" | "streamType" | "type" | "startTime" | "metadata" | "preferCmcd" | "_hlsConfig" | "tokens" | "drmTypeCb" | "maxAutoResolution">>, mediaEl: HTMLMediaElement) => Hls | undefined;
