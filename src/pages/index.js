...
const Context = createContext("scroll-context");
...
export default function Home() {
  ...
  // create context with all the data-start-y elements that scrollProvider will watch
                  ...
                  >
                    <div className="aspect-[1/1.5] md:scale-125 w-[80%] md:w-[60%] items-center justify-center flex-col flex">
                      ...
                      <div className="w-full flex justify-end">
                        <div className="imessage-right pop-in-2 flex flex-col w-max my-4">
                          Here!
                        </div>
                      </div>
                      <div className="w-full flex justify-end">
        ...
        <section data-scroll-visited="false" data-bg="neon" className="section-tile">
          ...
          <div className="tile">
            ...
            <div data-start-y="40" className="tile-text grid-reverse text-reverse">
              ...
              <div className="tile-text-bottom">
                One place to plan, search, cross&#8209;reference and find experiences curated for
                you.
              </div>
            </div>
            {/* /tile-text */}
                ...
                <div className="flex items-end h-full flex-row text-[1.75rem] px-0 leading-120 md:leading-150 tracking-1 font-[Golos]">
                  <div className="flex flex-row">
                    ...
                    <div className="max-w-[552px]">
                      ...
                      <span className="text-[--ocean]">city playlist</span> that captures that time
                      of your life.
                    </div>
                  </div>
                </div>
